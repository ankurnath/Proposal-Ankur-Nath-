...
The proposed work draws on four areas of prior research: the theory of submodular
maximization, classical pruning methods, learning-based pruning methods, and automated
feature engineering using large language models. This chapter reviews existing work in
each area and highlights the limitations that motivate the contributions of this proposal.
...
related line of work constructs \textit{coresets}: compact summaries that approximately
preserve objective values for reuse across queries~\citep{mirzasoleiman2020coresets}.
QuickPrune's pruned universe serves a similar role, but is designed for the value oracle
model and supports a range of budgets simultaneously rather than a single query type.
...
COMBHelper, a GNN-based framework with knowledge distillation, which still relies on
