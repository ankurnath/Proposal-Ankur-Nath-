...
\begin{table}[h!]
	...
	\end{tabular}
	\caption{San Japan attendance. Data is taken from \citep{ANCONS}. I intentionally make the title of this table long so the single space effect is seen in the list of tables.}
\end{table}
