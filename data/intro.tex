...
methods~\citep{zhou2017scaling}, applicability to only a single CO problem in methods designed for maximum clique
enumeration~\citep{lauri2019fine, grassia2019learning, lauri2023learning} or the traveling
salesman problem~\citep{fitzpatrick2021learning, sun2021generalization}, reliance on
hand-crafted, problem-specific features in learning-based
methods~\citep{manchanda2020gcomb, ireland2022lense, tian2024combhelper}, and a complete
...
is \#P-hard~\citep{chen2010scalable}. At the same time, existing learning-based pruning methods achieve fast
inference but demand problem-specific domain knowledge for feature engineering, making them
difficult to apply to new CO problems. To overcome both of these limitations, we propose
Hierarchical DeepPruner (H-DeepPruner)~\citep{nath2025hdeeppruner}, an adaptive
...
DeepPruner demonstrates that learning-based methods can achieve effective empirical
