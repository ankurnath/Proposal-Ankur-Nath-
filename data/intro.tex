...
to apply to new CO problems. To address this limitation, we propose
...
propose LLM2Prune, a framework that leverages large language
...
\textbf{Contributions.} In summary, \emph{This proposal presents a coherent framework for scaling combinatorial optimization
...
The remainder of this proposal is organized as follows. Chapter~\ref{chap:relatedwork} reviews related work
...
QuickPrune, Hierarchical DeepPruner, and LLM2Prune in detail, respectively. Chapter~\ref{chap:timeline}
presents the research timeline.