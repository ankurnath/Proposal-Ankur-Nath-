...
\lstset{basicstyle={\footnotesize\ttfamily},numbers=left,numberstyle=\footnotesize,
  xleftmargin=2em,aboveskip=0pt,belowskip=0pt,showstringspaces=false,
...
\renewcommand{\tamumanuscripttitle}{Efficient Pruning Strategies for\\Combinatorial Optimization on Graphs}
...
\renewcommand{\tamufullname}{Ankur Nath}

%The degree title goes here. See the GPS site for more info.
\renewcommand{\tamudegree}{Doctor of Philosophy}
\renewcommand{\tamuchairone}{Dr. Alan Kuhnle}


% Uncomment out the next line if you have co-chairs.  You will also need to edit the titlepage.tex file.
%\newcommand{\tamuchairtwo}{Additional Chair Name}
\renewcommand{\tamumemberone}{Dr. Yoonsuck Choe}
\newcommand{\tamumembertwo}{Dr. James Caverlee}
\newcommand{\tamumemberthree}{Dr. Abhishek Chakrabortty}
\renewcommand{\tamudepthead}{Dr. Scott Schaefer}

%Type only May, August, or December.
\renewcommand{\tamugradmonth}{\monthname}
\renewcommand{\tamugradyear}{\the\year}
...
\include{data/quickprune}
\include{data/hdeeppruner}
\include{data/llm2prune}
