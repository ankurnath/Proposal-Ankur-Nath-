...
\begin{frame}{Related Work: Search Space Pruning}
  \begin{columns}[T]
    \begin{column}{0.48\textwidth}
      \begin{block}{\faBook\; Classical approach}
        \begin{itemize}
          \item Submodular Sparsification~\cite{zhou2017scaling}: submodularity-based groud set
          ...
          \item Mirzasoleiman et al. ~\cite{mirzasoleiman2020coresets}: reduce training dataset while
    ...
    \begin{column}{0.48\textwidth}
      \begin{block}{\faBrain\; Learning-Based}
        \begin{itemize}
          ...
          \item Fitzpatrick et al.~\cite{fitzpatrick2021learning}, Sun et al.~\cite{sun2021generalization}: edge classifiers
            for \textbf{TSP}
