...
\begin{frame}{What is Combinatorial Optimization?}
  ...
  \begin{itemize}
    \item \textbf{Ground set $\mathcal{U}$:} the universe of candidate elements (e.g., nodes in a graph)
    \item \textbf{Objective $f$:} measures solution quality (e.g., influence spread, coverage)
    \item \textbf{Constraint $\Omega$:} limits which subsets are feasible (e.g., budget, cardinality)
  \end{itemize}
