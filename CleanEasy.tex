...
\begin{frame}{QuickPrune: Multi-Budget Generalization (Knapsack Constraint)}
  The multi-budget guarantee extends to general knapsack constraints. A single
  pruned ground set remains effective across all lower budgets.
  ...
  \begin{figure}
    ...
    \includegraphics[width=0.24\textwidth]{figures/quickprune/MaxCut_YouTube.pdf}%
    \includegraphics[width=0.24\textwidth]{figures/quickprune/MaxCut_Skitter.pdf}
    \caption{Knapsack constraint: $P_r$ across budgets for MaxCover (left) and
      MaxCut (right) on YouTube and Skitter graphs.}
  \end{figure}
\end{frame}
