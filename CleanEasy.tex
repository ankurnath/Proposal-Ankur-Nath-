...
\begin{frame}{Contributions}
  \centering
  \textit{A three-stage research arc: from provable guarantees to fully automated pruning.}
  ...
  \begin{columns}[T]
    ...
    \begin{column}{0.32\textwidth}
      \begin{block}{\faLightbulb\; LLM2Prune}
        ...
        Constraint-adaptive via text prompts.
      \end{block}
  ...
  \begin{alertblock}{Goal}
    ...
    million-node ground sets to lean candidate sets --- without sacrificing solution quality.
  \end{alertblock}
\end{frame}
