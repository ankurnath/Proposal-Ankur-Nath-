...
\aistatstitle{Theoretically Grounded Pruning of Large Ground Sets for Constrained, Discrete Optimization}

\aistatsauthor{Ankur Nath \And Alan Kuhnle }

\aistatsaddress{ Department of Computer Science and Engineering, Texas A\&M University } ]
...
\bibliography{reference,pruning}
\section*{Checklist}
