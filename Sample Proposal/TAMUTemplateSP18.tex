...
\usepackage{graphicx} % Required for adjusting table width
\usepackage{array} % Allows more control over column formatting
\usepackage{longtable} % Allows table to span multiple pages
...
\renewcommand{\tamumanuscripttitle}{Robust Intent Understanding in Dialogs: FROM DIALOG ACTS
TO ADVERSARIAL ROBUSTNESS}
% MODELING HIDDEN STRUCTURE & SITUATIONAL CONTEXT FOR DIALOGUE ACT RECOGNITION IN MULTIPARTY DIALOGUES
% Looking Beyond an Utterance: Modeling Hidden & Situational Context for Dialogue Act Recognition
...
\renewcommand{\tamufullname}{Md Messal Monem Miah}

%The degree title goes here. See the GPS site for more info.
\renewcommand{\tamudegree}{Doctor of Philosophy}
\renewcommand{\tamuchairone}{Dr. Ruihong Huang}


% Uncomment out the next line if you have co-chairs.  You will also need to edit the titlepage.tex file.
%\newcommand{\tamuchairtwo}{Additional Chair Name}
\renewcommand{\tamumemberone}{Dr. Anxiao Jiang}
\newcommand{\tamumembertwo}{Dr. Theodora Chaspari}
\newcommand{\tamumemberthree}{Dr. Xiaoning Qian}
\renewcommand{\tamudepthead}{Dr. Scott Schaefer}

%Type only May, August, or December.
\renewcommand{\tamugradmonth}{November}
...
\include{data/related_work}
\include{data/da_classification}
\include{data/db_detection}
\include{data/deception}
\include{data/JB_defence}
